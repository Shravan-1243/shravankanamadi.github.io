...
London, UK (PSW visa) · Open to BA/Data Analyst contract, freelance, and interim roles across the UK

**Technical Skills:** SQL, Python, Power BI, Tableau, Advanced Excel · **BA Skills:** Requirements Elicitation, BRD Authoring, Stakeholder Management, AS-IS/TO-BE Process Mapping, MoSCoW Prioritisation

[LinkedIn](https://www.linkedin.com/in/shravan-kanamadi-338715178/) · [GitHub](https://github.com/Shravan-1243) · shravankanamadi12@gmail.com
...
A Trust-level patient flow improvement case study grounded in real, published NHS England performance statistics (the national A&E 4-hour breach rate stood at 36.2% in March 2026).

- Authored a full Business Requirements Document (BRD): problem statement, scope, stakeholder summary, current/future-state analysis, MoSCoW requirements, risks, and benefits tracking
- Built a Mendelow Power/Interest stakeholder register with RACI assignment across 9 stakeholder groups
- Designed AS-IS and TO-BE swimlane process maps identifying the two highest-risk handoff points causing delay
- Defined functional and non-functional requirements for a real-time bed-management visibility tool
- Built a Power BI-style interactive dashboard tracking breach rate, trolley waits, and staffing metrics against defined targets

**Tech:** SQL · Python (pandas) · Power BI-style dashboard (Chart.js) · MS Word (BRD) · Excel (RACI/stakeholder mapping) · BPMN-style process mapping

🔗 Repository: [nhs-ae-patient-flow-ba-case-study](https://github.com/Shravan-1243/nhs-ae-patient-flow-ba-case-study)

### 🛒 Retail Self-Checkout Improvement

A process improvement case study for retail self-checkout operations.

- Authored a Business Requirements Document (BRD) and stakeholder register
- Built AS-IS and TO-BE process maps for the self-checkout customer journey
- Applied MoSCoW prioritisation to define functional requirements for the proposed solution

**Tech:** MS Word (BRD) · Excel (stakeholder register) · BPMN-style process mapping

🔗 Repository: [retail-self-checkout-ba-case-study](https://github.com/Shravan-1243/retail-self-checkout-ba-case-study)
